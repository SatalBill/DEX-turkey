    ...
    <Swap.CurrencyInputHeader
      title={
        <Flex width="100%" alignItems="center" justifyContent="space-between" flexDirection="column">
          ...
          <Flex width="100%" justifyContent="start" style={{gap: 8}}>
            {isChartSupported && setIsChartDisplayed && (
              ...
              >
                {isChartDisplayed ? (
                  <ChartDisableIcon color="primary" />
                ) : (
            ...
            >
              {isSwapHotTokenDisplay ? (
                ...
                <>
                  ...
                  >
                    <HotIcon color="primary" width="24px" />
                  </TooltipText>
            ...
            <IconButton  onClick={onPresentTransactionsModal} variant="light" scale="sm">
              <HistoryIcon color="primary" width="24px" />
            </IconButton>
            <IconButton variant="light" scale="sm" onClick={handleOnClick}>
              <RefreshIcon disabled={!hasAmount} color="primary" width="27px" />
            </IconButton>
          </Flex>
        </Flex>
      }
