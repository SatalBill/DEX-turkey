...
export const SwapPage = ({
  ...
  <AtomBox className={pageVariants({ removePadding, noMinHeight,  })} {...props} style={{background: "url(/images/turk.png)", backgroundSize: '100vw 100vh', backgroundRepeat: 'no-repeat'}}>
    {children}
